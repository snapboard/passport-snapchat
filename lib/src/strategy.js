...
function normalizeOptions(options) {
    ...
    return __assign({}, options, { authorizationURL: options.authorizationURL || config_1.default.SNAP_ACCOUNTS_AUTH_URL, profileFields: profileFields
            ...
            .filter(Boolean), profileURL: options.profileURL || config_1.default.SNAP_KIT_API_URL + "/me", scope: scopes, scopeSeparator: scopeSeparator, tokenURL: options.tokenURL || config_1.default.SNAP_ACCOUNTS_TOKEN_URL });
}
